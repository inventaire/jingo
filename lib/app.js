...
module.exports.initialize = function (config) {
  ...
  app.use(function (err, req, res, next) {
    ...
    console.log(err)
    res.render('500.jade', {
      message: 'Sorry, something went wrong and I cannot recover. If you think this might be a bug, please file a detailed report about what you were doing here: https://github.com/inventaire/jingo/issues . Thank you!',
      error: err
    })
  })
